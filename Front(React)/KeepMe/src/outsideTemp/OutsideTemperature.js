...
export default function OutsideTemperature({ outsideTemperature }) {
  ...
  return (
    <div className={styles.container}>
      <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M480-100q-74.92 0-127.46-52.54Q300-205.08 300-280q0-45.69 21.19-84.69 21.2-39 58.81-64.54V-760q0-41.92 29.04-70.96Q438.08-860 480-860q41.92 0 70.96 29.04Q580-801.92 580-760v330.77q37.61 25.54 58.81 64.54Q660-325.69 660-280q0 74.92-52.54 127.46Q554.92-100 480-100Zm-40-412.31h80v-50h-40v-35.38h40v-84.62h-40v-35.38h40V-760q0-17-11.5-28.5T480-800q-17 0-28.5 11.5T440-760v247.69Z"/></svg>
      <div className={styles.temperature}>
        <span className={styles.temperatureValue}>{outsideTemperature&&outsideTemperature.length>0?outsideTemperature[outsideTemperature.length-1].toFixed(1):'N/A'}°C</span>
      </div>
    </div>
  )
}
