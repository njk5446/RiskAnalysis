...
export default function PCountBar({ userCount, normalCount, cautionCount, dangerCount }) {
    ...
    return (
        <div className="flex flex-wrap justify-around">
            <div className="flex flex-col items-center justify-center absolute w-[22vw] h-[10.5vh] sm:w-[20vw] sm:h-[9.5vh] lg:w-[18vw] lg:h-[8.5vh] left-[2.5vw] top-[3vw] bg-[#ffffffdc] rounded-[15px] z-10 hover:scale-105 transition-transform">
            ...
            <div className="flex flex-col items-center justify-center absolute w-[22vw] h-[10.5vh] sm:w-[20vw] sm:h-[9.5vh] lg:w-[18vw] lg:h-[8.5vh] left-[21.5vw] top-[3vw] bg-[#6edf87d7] rounded-[15px] z-10 hover:scale-105 transition-transform">
            ...
            <div className="flex flex-col items-center justify-center absolute w-[22vw] h-[10.5vh] sm:w-[20vw] sm:h-[9.5vh] lg:w-[18vw] lg:h-[8.5vh] left-[40.5vw] top-[3vw] bg-[#eab24ad7] rounded-[15px] z-10 hover:scale-105 transition-transform">
            ...
            <div className="flex flex-col items-center justify-center absolute w-[22vw] h-[10.5vh] sm:w-[20vw] sm:h-[9.5vh] lg:w-[18vw] lg:h-[8.5vh] left-[59.5vw] top-[3vw] bg-[#e95454d3] rounded-[15px] z-10 hover:scale-105 transition-transform">
                ...
                <p className="absolute left-4 top-[43%] text-[25px] font-sans text-white mt-2">{dangerCount}</p>
            </div>
        </div>
